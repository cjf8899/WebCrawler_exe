...
class PushButtonWindow(QMainWindow):
    ...
    def setupUI(self):
        ...
        self.label = QLabel("개수", self)
        self.label.move(155,20)
        self.label.resize(100,20)

        self.lineEdit2 = QLineEdit("", self)
        self.lineEdit2.move(185,20)
        self.lineEdit2.resize(100,20)
        self.lineEdit2.textChanged.connect(self.lineEdit_textChanged2)


    def btn_clicked(self):
        QMessageBox.about(self, "Start Crawling", "'" + self.lineEdit.text()+"' 크롤링을 시작합니다.")
        f = open("./keywords.txt", 'w',encoding='utf8')
        f.write(self.lineEdit.text())
        f.close()
        print(self.lineEdit.text())
        crawling(self.lineEdit2.text())
        exit()
    ...
    def  lineEdit_textChanged2(self):
        pass
